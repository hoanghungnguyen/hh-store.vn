            ...
            ?>
                <div class="col-md-4">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" name="tensanpham" class="form-control" value="<?php echo $row_capnhat_sp['sanpham_name'] ?>">
                        ...
                        <input type="text" name="giakhuyenmai" class="form-control" value="<?php echo $row_capnhat_sp['sanpham_giakhuyenmai'] ?>">
                        <label for="">Số lương</label>
                        <input type="text" name="soluong" class="form-control" value="<?php echo $row_capnhat_sp['sanpham_soluong'] ?>">
                        <label for="">Mô tả</label>
                        <textarea name="mota" class="form-control"><?php echo $row_capnhat_sp['sanpham_mota'] ?></textarea>
                        <label for="">Chi tiết</label>
                        <textarea name="chitiet" class="form-control"><?php echo $row_capnhat_sp['sanpham_chitiet'] ?></textarea>
                        ...
                        <input style="margin-top: 15px;" type="submit" name="capnhatsanpham" class="btn btn-default btn-outline-success " value="Cập nhật sản phẩm">
                    </form>
                </div>
            <?php } else { ?>
                <div class="col-md-4">
            ...
            <div class="col-md-8">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-default btn-outline-success" href="?quanly=xoa&id=<?php echo $row_sp['sanpham_id'] ?>">Xóa</a>
                            <a class="btn btn-default btn-outline-success" href="?quanly=update&id=<?php echo $row_sp['sanpham_id'] ?>">Cập nhật</a>
                        </td>
                    </tr>
                    <!-- <?php } ?> -->
                </table>
